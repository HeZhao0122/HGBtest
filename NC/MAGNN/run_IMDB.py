...
from utils.tools import evaluate_results_nc, get_simM, sim_loss
...
def run_model_IMDB(feats_type, num_layers, hidden_dim, num_heads, attn_vec_dim, rnn_type,
    ...
    for _ in range(repeat):
        ...
        for epoch in range(num_epochs):
            ...
            loss_sim = sim_loss(simM, embeddings, train_idx)
            train_loss += loss_sim
            ...
            with torch.no_grad():
                ...
                val_sim_loss = sim_loss(simM, embeddings, val_idx)
                val_loss += val_sim_loss
